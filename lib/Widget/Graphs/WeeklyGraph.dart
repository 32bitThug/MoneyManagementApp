          ...
          SizedBox(
            ...
            child: Card(
              ...
              child: SfCartesianChart(
                primaryXAxis:
                    CategoryAxis(title: AxisTitle(text: 'Weekly Expenditure')),
                ...
                series: <CartesianSeries>[
                  ColumnSeries<WeeklyData, String>(
                      dataSource:
                          dataAnalysis.getWeeklyCreditData(credit.analysisData),
                      xValueMapper: (WeeklyData weeklyData, _) =>
                          weeklyData.weekDay,
                      yValueMapper: (WeeklyData weeklyData, _) =>
                          weeklyData.amount.round(),
                  ...
                  ColumnSeries<WeeklyData, String>(
                      dataSource:
                          dataAnalysis.getWeeklyDebitData(debit.analysisData),
                      xValueMapper: (WeeklyData weeklyData, _) =>
                          weeklyData.weekDay,
                      yValueMapper: (WeeklyData weeklyData, _) =>
                          weeklyData.amount.round(),
