    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProxyProvider<Authentication, CreditData>(
          create: (_) => CreditData('', [], ''),
          update:
              (ctx, authentication, prevCreditData) => CreditData(
                authentication.authToken,
                prevCreditData == null ? [] : prevCreditData.data,
